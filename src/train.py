...
if __name__ == '__main__':
    ...
    parser.add_argument("-pretrained_from", default='')  # path to pretrained bert sum
    parser.add_argument("-loss_function", default='bce')  # ['smooth_bce', 'bce']
    parser.add_argument("-smoothing", default=0.1)  # for label smoothing
